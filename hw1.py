...
def main(balance, apr, targetamount, credit_line, fees=0):
    """_summary_
    ...
    if targetamount == None:
        print(f" Your recommended minimum payment is ${get_min_payment(balance, fees)}.")
        pays_minimum = True
    ...
    print(f"You will spend a total of {balancecounter25} months over 25% of the credit line.")
    print(f"You will spend a total of {balancecounter50} months over 50% of the credit line.")
    print(f"You will spend a total of {balancecounter75} months over 75% of the credit line.")
